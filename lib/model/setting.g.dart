...
extension SettingQueryFilter
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameEqualTo(
    String? value, {
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'name',
        value: '',
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> valueIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'value',
      ));
  ...
  QueryBuilder<Setting, Setting, QAfterFilterCondition> valueIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'value',
      ));
...
extension SettingQuerySortBy on QueryBuilder<Setting, Setting, QSortBy> {
  QueryBuilder<Setting, Setting, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Setting, Setting, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingQuerySortThenBy
  ...
  QueryBuilder<Setting, Setting, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Setting, Setting, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension SettingQueryWhereDistinct
  ...
  QueryBuilder<Setting, Setting, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SettingQueryProperty
  ...
  QueryBuilder<Setting, String?, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
